...
function loadWindytv() {
	...
	//h.innerHTML = '<div id="map_container" style="width:100%; height:100%;"></div><div id="contrib">OSM & contributors</div><div id="legend"></div><canvas id="jpg_decoder" style="display: none;"></canvas><div id="globe_container"></div><a class="logo" style="display: none;" href="https://www.windy.com" target="wndt"><img class="w" src="https://www.windy.com/img/ikona.svg"><img class="text" src="https://www.windy.com/img/logo-windytv.svg"></a>';
	//h.innerHTML = '<div id="map_container" style="width:100%; height:100%;"></div><div id="legend"></div><canvas id="jpg_decoder" style="display: none;"><div id="globe_container"></div>';
	h.innerHTML = '<div id="map_container" style="width:100%; height:100%;"></div><div id="contrib" style="display: none;">OSM & contributors</div><div id="legend"></div><canvas id="jpg_decoder" style="display: none;"></canvas><div id="globe_container"></div><a class="logo" style="display: none;" href="https://www.windy.com" target="wndt"><img class="w" src="https://www.windy.com/img/ikona.svg"><img class="text" src="https://www.windy.com/img/logo-windytv.svg"></a>';

	//b(g + "api.css");
	b(windytyInit.apiCss);
	a("https://www.windy.com/gfs/minifest.js", function() {
		//a(g + "api.js?key=" + windytyInit.key, d)
		a(windytyInit.apiJs, d)
	});
