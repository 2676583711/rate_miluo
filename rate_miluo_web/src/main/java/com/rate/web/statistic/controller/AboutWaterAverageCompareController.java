...
@Controller
@RequestMapping("/statistic/aboutWaterAverageCompare")
public class AboutWaterAverageCompareController extends BaseController {
    @Autowired
    ...
    public List<AirStationInfoVo> getStaionInfos(HttpServletRequest request) {
