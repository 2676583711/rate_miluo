...
import com.rate.web.statistic.dto.AirConstant;
...
@Controller
@RequestMapping("/statistic/chainCompare")
public class AirChainCompareController extends BaseController {
    @Autowired
    ...
    public Map<String, Object> chainCompareList(@RequestParam Map<String, Object> params) {
        ...
        params = DateParamUtil.initParam(params, Calendar.MONTH);
