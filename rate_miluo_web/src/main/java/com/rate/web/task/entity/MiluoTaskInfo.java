...
public class MiluoTaskInfo  {
	...
	@ExcelField(title = "任务类型", sort = 9)
	private String taskType ;
	//结束时间
	@ExcelField(title = "结束时间", sort = 7)
	private Date endTime ;
	//开始时间
	@ExcelField(title = "开始时间", sort = 6)
