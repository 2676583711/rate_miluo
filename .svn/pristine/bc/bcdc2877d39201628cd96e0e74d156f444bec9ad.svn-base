 ...
 */
package com.rate.system.rate_system.utils.config;
...
public class PropertiesUtils {
	...
	private static final class PropertiesLoaderHolder {
		...
		public static void releadInstance(){
			...
			Resource[] resources = ResourceUtils.getResources("classpath*:/config/application*.*");
			...
			logger.debug("Loading rate config: {}", configFiles);
