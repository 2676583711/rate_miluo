package com.rate.system.rate_system.aspect;
...
import com.rate.system.rate_system.utils.HttpContextUtils;
import com.rate.system.rate_system.utils.IPUtils;
...
public class LogAspect {
    ...
    @Pointcut("@annotation(com.rate.system.rate_system.annotation.Log)")
