...
public class UserEPX implements Serializable {
    ...
    @ExcelField(title = "上级领导", groups = 1, sort = 6)
    ...
    // 密码
    @ExcelField(title = "密码", groups = 1, sort = 3)
    ...
    // 手机号
    @ExcelField(title = "联系方式", groups = 1, sort = 4)
    private String mobile;
    // 状态 0:禁用，1:正常
    private Integer status;
    @ExcelField(title = "状态", groups = 1, sort = 7)
    ...
    //职位
    @ExcelField(title = "职位", groups = 1, sort = 5)
    private String workName;
    //角色名
    @ExcelField(title = "角色", groups = 1, sort = 8)
