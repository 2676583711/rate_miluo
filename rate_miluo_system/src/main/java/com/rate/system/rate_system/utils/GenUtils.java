...
import com.rate.system.rate_system.entity.Column;
import com.rate.system.rate_system.entity.Table;
...
public class GenUtils {
	...
	private final static String PATH = System.getProperty("user.dir") + File.separator + "src" + File.separator;
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        for (Map<String, String> column : columns) {
           ...
           // columnDO.setExtra(column.get("extra"));
            ...
            //是否主键
            if ("P".equalsIgnoreCase(column.get("COLUMNKEY")) && tableDO.getPk() == null) {
        ...
        for (String template : templates) {
            ...
            try {
            	String pwPath = PATH + getFileName(template, tableDO.getClassname(), tableDO.getClassName(), config.getString("package"));
            	File file = new File(pwPath.substring(0, pwPath.lastIndexOf(File.separator)));
               ...
               // zip.putNextEntry(new ZipEntry(getFileName(template, tableDO.getClassname(), tableDO.getClassName(), config.getString("package"))));
                pw = new PrintWriter(new File(pwPath));
    ...
    public static String getFileName(String template, String classname, String className, String packageName) {
    	String javaPath = packageName.replace(".", File.separator);
